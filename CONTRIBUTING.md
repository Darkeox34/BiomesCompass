# Contributing to BiomesCompass

First off, thank you for considering contributing to BiomesCompass! It's people like you that make open-source projects like this thrive.

## Where to Start

- **Bug Reports:** If you find a bug, please open an issue on the project's GitHub repository or contact me on Discord. Be sure to include as much detail as possible, including steps to reproduce the bug.
...
2. **Clone your fork:** `git clone https://github.com/Darkeox34/BiomesCompass.git`
